 ...
 * @author liemtpt
 */
public class BrandServlet extends HttpBasePage<BrandServlet> {

    private static final Logger logger = LogUtil.getLogger(BrandServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            if(FunctionUtils.checkAccessToken(request, response, mapParams)){
                mapParams.put("module", "brands");
                int version = ConvertUtils.toInt(mapParams.get("version"), 1);
                version = getVersion("brands", version);
                
                String _packageControler = getPackageHandler(BrandServlet.class, version);
