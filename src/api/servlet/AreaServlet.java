 ...
 * @author liemtpt
 */
public class AreaServlet extends HttpBasePage<AreaServlet> {

    private static final Logger logger = LogUtil.getLogger(AreaServlet.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            if(FunctionUtils.checkAccessToken(request, response, mapParams)){
                mapParams.put("module", "areas");
                int version = ConvertUtils.toInt(mapParams.get("version"), 1);
                version = getVersion("areas", version);
                
                String _packageControler = getPackageHandler(AreaServlet.class, version);
