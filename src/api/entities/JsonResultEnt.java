...
public class JsonResultEnt {
    ...
    static public JsonResultEnt getJsonTransactionError(String message) {
        return new JsonResultEnt(ErrorCode.TRANSACTION_ERROR.getValue(), message);
    }

//    INVALID_SECRET_KEY(225),
//    TOKEN_NOT_WRITE(226),
//    UNKNOW_ERROR(227),
